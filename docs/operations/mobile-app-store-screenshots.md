...
The Environments capture presents the three local fixture transports as remote-looking hostnames
and addresses. This display-only substitution keeps the cards remote-first while the harness
retains reliable loopback connections to its ephemeral servers.

 ...
 * origin is also what makes remote connections work unchanged — direct pairing
 * and remote access already carry `/api/*` and WebSocket upgrades for the app itself.
 *

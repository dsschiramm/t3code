...
// The server reads these off the /ws upgrade URL next to wsTicket to stamp a
// command's originating client. Optional on both ends: old servers ignore
// unknown params, old clients never send them.

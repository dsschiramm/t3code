...
const INSTALL_CHECKING = { type: "checking" } as unknown as ServerSelfUpdateProgressEvent;
const INSTALL_DOWNLOADING = { type: "downloading" } as unknown as ServerSelfUpdateProgressEvent;
